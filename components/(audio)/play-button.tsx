...
export function PlayButton({
  ...
  return (
    <button
      type="button"
      className={clsxm(
        "group relative flex flex-shrink-0 items-center justify-center rounded-full bg-neutral-700 outline-none hover:bg-neutral-900 dark:bg-neutral-700 dark:ring-neutral-500 dark:hover:bg-neutral-600 dark:focus:bg-neutral-500 dark:focus:ring-neutral-700",
        {
